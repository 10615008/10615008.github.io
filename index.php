  ...
  <div class="alert alert-success alert-dismissible" role="alert" >
    ...
    <strong>豪華套房 </strong><a href="總統套房.php">給您總統級的享受</a><br>
	  ...
	  <div class="row text-center">
        <div class="col-md-4">
          <img class="img-circle" src="房間/優雅套房.jpg" width="275" height="183">
          <h3>優雅套房</h3>
          <p> <br><br><br><br><br><br><br></p>
          <p><a class="btn btn-default" href="store.php" role="button">訂房&raquo;<</a></p>
        </div>
        <div class="col-md-4">
          <img class="img-circle" src="房間/總統套房.jpg" width="275" height="183">
          <h3>總統套房</h3>
          <p> <br><br><br><br><br><br><br></p>
          <p><a class="btn btn-default" href="store.php" role="button">訂房&raquo;</a></p>
        </div>
        <div class="col-md-4">
          <img class="img-circle" src="房間/藍色水玲瓏套房.jpg" width="275" height="183">
          <h3>藍色水玲瓏套房</h3>
          <p> <br><br><br><br><br><br><br></p>
          <p><a class="btn btn-default" href="store.php" role="button">訂房&raquo;</a></p>
        </div>	
    ...
    <div class="container">
	  <div class="row text-center">
        <div class="col-md-4">
          <img class="img-circle" src="房間/電競套房.jpg" width="275" height="183">
          <h3>電競套房</h3>
          <p> <br><br><br><br><br><br><br></p>
          <p><a class="btn btn-default" href="store.php" role="button">訂房&raquo;</a></p>
        </div>
        <div class="col-md-4">
          <img class="img-circle" src="房間/總裁套房.jpg" width="275" height="183">
          <h3>總裁套房</h3>
          <p> <br><br><br><br><br><br><br></p>
          <p><a class="btn btn-default" href="store.php" role="button">訂房&raquo;</a></p>
        </div>
        <div class="col-md-4">
          <img class="img-circle" src="房間/綠意盎然套房.jpg" width="275" height="183">
          <h3>綠意盎然套房</h3>
          <p> <br><br><br><br><br><br><br></p>
          <p><a class="btn btn-default" href="store.php" role="button">訂房&raquo;</a></p>
        </div>	
